    ...
    },
    {
        ...
        },
        {
            ...
            make=function()
                ...
                en=Enemy{x=400,y=300,mainEnemy=true,maxhp=96000000,hpSegments={0.7,0.4},hpSegmentsFunc=function(self,hpLevel)
                    if hpLevel==1 then
                        angleNum=3
                        sideNum=7
                    elseif hpLevel==2 then
                ...
                G.backgroundPattern:remove()
                G.backgroundPattern=backgroundPattern.FollowingTesselation{sideColor={0.5,0.2,1,1},sideNum=sideNum,angleNum=angleNum,toDrawNum=50}
                ...
                a=BulletSpawner{x=400,y=300,period=240,frame=160,lifeFrame=10000,bulletNumber=0,bulletSpeed=0,bulletLifeFrame=350,angle=0,range=math.pi*2,bulletSprite=BulletSprites.scale.yellow,spawnBatchFunc=function(self)
                    ...
                    for key,side in pairs(sides) do
                        ...
                        local tab={x=x1,y=y1,period=1,frame=0,lifeFrame=1,bulletNumber=1,bulletSpeed=60,bulletLifeFrame=120,angle=angle1,range=math.pi*2,bulletSprite=BulletSprites.bill.purple,bulletEvents={
                            function(cir,args,self)
                                local t0=en.frame
                                ...
                                Event.LoopEvent{
                                    ...
                                    executeFunc=function()
                                        if cir.frame%10==0 then
                                            local cir2=Circle{x=cir.x,y=cir.y,direction=Shape.to(cir.x,cir.y,centerRef[1],centerRef[2])+3.14,speed=0,sprite=BulletSprites.bill.yellow,lifeFrame=10000,}
                                            Event.DelayEvent{
                                                obj=cir2,
